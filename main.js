...
let profile = {
  ...
  image: 'https://placehold.co/105x105/1a6b9a/white?text=Mayeesha',
  followers: 26
};
let books = [
  {id:1, title:"দ্য সাইফার (হার্ডকভার)", author:"by শিবলী মল্লিক, মায়িশা ফারজানা (অনুবাদক)", publisher:"সায়েন্স ফিকশন", originalPrice:580, price:406, discount:30, rating:5, ratingCount:13, cover:"https://placehold.co/165x237/1a6b9a/ffffff?text=The+Cipher", inStock:true},
  {id:2, title:"মানুষ (হার্ডকভার)", author:"মায়িশা ফারজানা", publisher:"সায়েন্স ফিকশন", originalPrice:299, price:249, discount:17, rating:5, ratingCount:1, cover:"https://placehold.co/165x237/1a6b9a/ffffff?text=Manush", inStock:true},
  {id:3, title:"হালো-সাই-ফাই-ইয়ার (হার্ডকভার)", author:"মায়িশা ফারজানা", publisher:"সায়েন্স ফিকশন", originalPrice:209, price:159, discount:24, rating:5, ratingCount:7, cover:"https://placehold.co/165x237/1a6b9a/ffffff?text=Halo+Sci-Fi", inStock:true},
  {id:4, title:"জম্বিদের মুখোশ (হার্ডকভার)", author:"by শিবলী মল্লিক, মায়িশা ফারজানা (অনুবাদক)", publisher:"সায়েন্স ফিকশন", originalPrice:269, price:230, discount:14, rating:5, ratingCount:3, cover:"https://placehold.co/165x237/1a6b9a/ffffff?text=Zombie", inStock:true},
  {id:5, title:"সত্তা বিন্দু (হার্ডকভার)", author:"মায়িশা ফারজানা", publisher:"সায়েন্স ফিকশন", originalPrice:299, price:210, discount:30, rating:5, ratingCount:7, cover:"https://placehold.co/165x237/1a6b9a/ffffff?text=Sotta+Bindu", inStock:true}
];
...
function renderProfile() {
  ...
  img.src = profile.image || 'https://placehold.co/105x105/1a6b9a/white?text=Author';
  img.onerror = function() { this.src = 'https://placehold.co/105x105/1a6b9a/white?text=Author'; };
  ...
  grid.innerHTML = list.map(function (b) {
    ...
    return '<div class="book-card">' +
      '<div class="book-img-wrap">' +
        '<img src="' + (b.cover || 'https://placehold.co/165x237/1a3c5e/white?text=Book') + '" alt="' + b.title + '" onerror="this.src=\'https://placehold.co/165x237/1a3c5e/white?text=Book\'">' +
...
function renderCart() {
  ...
  el.innerHTML = cart.map(function (c) {
    ...
    return '<div class="cs-item">' +
      '<img src="' + (c.cover || '') + '" onerror="this.src=\'https://placehold.co/56x76/1a3c5e/white?text=Book\'" alt="' + c.title + '">' +
